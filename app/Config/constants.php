<?php
/* Database config */
define("DB_ADDR",'192.168.168.11');
define("DB_NAME","multi_language");
define("DB_USER",'rsdn');
define("DB_PASS","rsdn20120903");
define('FROM_LANGUAGE','ja');//jpn,ja
define('TO_LANGUAGE_EN','en');//eng,en
define('TO_LANGUAGE_VIE','vi');//eng,en
...
define('LENGTH_LAT',108);
define('LENGTH_LONG',108);
define('DOMAIN', 'http://118.69.77.23:8096/');
