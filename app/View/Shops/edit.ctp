                ...
                <?php endif; ?>                    
                    ...
                    <?php else: ?>
                        <td colspan="5" class="ie_four" >
                            ...
                            <?php 
                                echo $this->Form->input('word_0',array('id'=>'FShopWord0','class'=>'noBorder width100','type'=>'textarea','rows'=>1,'onblur'=>"return handleWord(this.id,11,'FShopShopJpId')",'value'=>$menu['DictJa']['word_0']));
                            ?>
                            <?php 
                                echo $this->Form->hidden('shop_jp_id');
                            ?>                    
