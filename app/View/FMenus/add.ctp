<style type="text/css">
        ...
        .noClass label{font-weight: 100;}
        .noClass input{margin-right: 10px;float: left; }
</style>
<div class="inner">
        <?php echo $this->Form->create('FMenu',array('url'=>array('action'=>'saveFmenu'),'id'=>'FMenuAddForm','type'=>'file','inputDefaults'=>array('label'=>false,'div'=>false,'novalidate'=>true))) ?>
            <?php 
                echo $this->Form->hidden('id');
                echo $this->Form->hidden('shop_id');
                echo $this->Form->hidden('edit',array('value'=>($checkEdit == 1)?1:''));
            ?> 
            <table class="three_table four_table">
                ...
                <?php endif; ?>
                    ...
                    <tr>
                        ...
                        echo $this->Form->input('payment_method', array('type'=>'select', 'multiple'=>'checkbox','options'=> array( '1'=>__('現金'), '2'=>__('クレジットカード'), '3'=>__('トラベラーカード')),'selected'=>$selected,'div'=>false,'label'=>false,'class'=>'noClass'));
                         ?> 
                         </fieldset> 
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <?php echo $this->Form->input('calories',array('type'=>'textarea','rows'=>1,'class'=>'noBorder width100','onblur'=>"return handleWord(this.id,10,'FMenuCalorie')")); ?>
                            ...
                            <div class="div_image">
                                <?php 
                                  echo $this->Form->input('image',array(
                                      ...
                                      'type'        =>'file',
                                      'style'       =>'display:block',
                                       'onChange'=>'$("#demoImage").hide();return showImage(this,"imgProduct",150,150)',
                                       'aria-required'=>'false'
                                  )); 
                                  ?>
                            </div>
            ...
            <div class="sbButton">
                    ...
                    <?php echo $this->Form->button('変更',array('type'=>'submit','class'=>'submitBut','div'=>false/*,'onclick'=>'return handleTranslate()'*/)); ?>
...
//     dataForm = $('#FMenuAddForm').serialize();

//     $.ajax({
//         type:'POST',
//         url:'<?php echo $this->Html->url(array('controller'=>'FMenus','action'=>'handleTranslate')); ?>',
//         data:{data:dataForm},
//         async:false,
//         success: function(data){
//         data = $.parseJSON(data);           
